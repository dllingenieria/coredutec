...
set_time_limit(0);
  ...
  if (isset ($_POST['hiddcodigo1'])) {$_POST['hiddcodigo'] = $_POST['hiddcodigo1'];
									  $_POST['hiddModulo'] = $_POST['hiddModulo1'];}
		...
		class PDF extends FPDF
		{
			...
			function Header()
			{
				if ($_POST['hiddModulo'] == "modulo"){
					...
					$this->SetFont('Arial','B',10);
					//Movernos a la derecha
					$this->Cell(270,5,utf8_decode("VIGILADA MINEDUCACIÓN"),0,2,'C');
					...
					$this->SetFont('Arial','B',25);
					//Movernos a la derecha
					$this->Cell(270,20,utf8_decode($_POST['hiddNombEstu1']),0,2,'C');
					
					$this->SetFont('Arial','B',15);
					//Movernos a la derecha
					$this->Cell(270,10,utf8_decode("Identificado(a) con C.C ".$_POST['hiddIdenEstu1']." expedida en ".$_POST['hiddLugarExp1']),0,2,'C');
					
					$this->SetFont('Arial','B',12);
					//Movernos a la derecha
					$this->Cell(270,10,utf8_decode("Asistió al Curso"),0,2,'C');
					
					$this->SetFont('Arial','B',25);
					//Movernos a la derecha
					$this->Cell(270,15,utf8_decode($_POST['hiddNombreCur1']),0,2,'C');
					
					$this->SetFont('Arial','B',15);
					//Movernos a la derecha
					$this->Cell(270,15,utf8_decode("Con una duración total de ".strtoupper($_POST['hiddDuracion1'])),0,2,'C');
