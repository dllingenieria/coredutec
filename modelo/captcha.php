...
$captchaImage = imagecreatefrompng( "../vista/images/captcha.png" );
...
$textColor = imagecolorallocate( $captchaImage,14, 116, 160);
...
$imageInfo = getimagesize( "../vista/images/captcha.png" );
...
imagettftext( $captchaImage, 20, 0, 35, 35, $textColor, "../vista/fuentes/VeraBd.ttf", $key );
